...
Route::get('/edifici/{edificio}/edit','EdificiController@edit');                    //Edit crea un form per modificare un edificio

Route::put('/edifici/{edificio}','EdificiController@update');                       //Update salva le modifiche

Route::get('/aule/create','AuleController@create');                                 //Create crea un form per creare un’aula
...
// Route::get('/aule/{aula}/{stato}','AuleController@stato');                       // apre/chiude aula

Route::get('/aule/{aula}/edit','AuleController@edit');                              //Crea un form per modificare i dati di un’aula

Route::get('/aule/{aula}','AuleController@show');                                   // Mostra un’aula specifica
...
Route::get('/mappe/create','MappeController@create');                               //Crea un form per aggiungere una mappa
...
Route::get('/mappe/{edificio}/{piano}/edit','MappeController@edit');                //Crea un form per modificare la mappa di un piano

Route::put('/mappe/{edificio}/{piano}','MappeController@update');                   //Registra le modifiche alla mappa

Route::get('/prenotazioni/create','PrenotazioniController@create');                 //Mostra un form per creare una nuova prenotazione
...
Route::get('/prenotazini/{prenotazione}/delete','PrenotazioniController@delete');   //Elimina una prenotazione

Route::get('/prenotazioni/{prenotazione}/edit','PrenotazioniController@edit');      //Crea un form per modificare una prenotazione
